...
{
    class DadosPrefeito : PathFile
    {
        //atributos para definir o primeiro e ultimo da celula Votacao para prefeito
                        ...
                        if (item.Cargo == "P")
                        {
                            ...
                            else
                            {
                                ...
                                if (aux.Prox != null)
                                {
                                    ...
                                    aux.Prox.Cargo = "Prefeito"; //copia o item a ser inserido nesta nova célula
        ...
        public void resultado(RichTextBox txt, string linha1, string linha2, Votacao candidato1, Votacao candidato2)
        {
            string porcentagem1 = null;
            string resultado = null;

            for (int i = 0; i < linha1.Length; i++)
            {
                if (linha1[i] != '%')
                    porcentagem1 += linha1[i];
            }

            if (Convert.ToDouble(porcentagem1) > 50.0)
            {
                resultado = "APURAÇÃO: \n" +
                    "O Candidato foi Eleitor para Prefeito \n\n" +
                    "Nome: " + candidato1.Nome + "\n" +
                    "Numero: " + candidato1.Numero + "\n" +
                    "Partido: " + candidato1.Partido + "\n" +
                    "Total de Votos: " + candidato1.TotalVotos + "\n" +
                    "Porcetagem de Votos: " + linha1;
            ...
            {
                resultado = "APURAÇÃO: \n" +
                    "Hávera segundo turno entre os candidatos para Prefeito \n\n" +
                    "Candidato 1: \n" +
                    "Nome: " + candidato1.Nome + "\n" +
                    "Numero: " + candidato1.Numero + "\n" +
                    "Partido: " + candidato1.Partido + "\n" +
                    ...
                    "Porcetagem de Votos: " + linha1 +
                    "\n\n\nCandidato 2: \n" +
                    "Nome: " + candidato2.Nome + "\n" +
                    "Numero: " + candidato2.Numero + "\n" +
                    "Partido: " + candidato2.Partido + "\n" +
                    "Total de Votos: " + candidato2.TotalVotos + "\n" +
                    "Porcetagem de Votos: " + linha2;
